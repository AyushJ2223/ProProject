...
export default function Ask(props) {
  ...
  const [askText, setAskText] = useState("Would you make my heart the happiest by being my Valentine? 💖✨");
  ...
  const handleNoClick = (event) => {
    ...
    if (noCount === 0) {
      ...
      setAskText("Bye I hope you find a happy world without me .")
      setEmojiAsk('😭')
  ...
  const handleYesClick = (event) => {
    ...
    setAskText("Yayy.. let's start a new world of us! ")
    setEmojiAsk('😍');
    setYesOrNow("Yes");
  }
  ...
  return (
    <div className='message-sending-body flex items-center flex-col w-full h-full bg-transparent bg-gradient-to-tr from-[#F56217] to-[#0B486B] min-h-screen gap-6 sm:gap-20'>
      ...
      <div className="ask-convey px-4 flex flex-col flex-wrap items-center gap-3 sm:gap-7">
        <div className='convey h-fit w-fit text-transparent bg-clip-text  bg-gradient-to-t from-[#962820] to-[#111125] sm:text-4xl text-center select-none'>In a world brimming with over 7 billion extraordinary souls, you stand out to me as exceptionally beautiful and charming and Yes I fell for you...</div>
